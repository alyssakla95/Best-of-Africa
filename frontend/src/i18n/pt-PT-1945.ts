...
export const PORTUGUESE_INTERFACE_PHRASES: Readonly<Record<string, string>> = {
  ...
  '$750 fixed · one country · 10 business days': '750 $ fixos · um país · 10 dias úteis',
  '$1,800 fixed · up to three countries · four weeks': '1 800 $ fixos · até três países · quatro semanas',
  ...
  'Complete reader access from $4 a month': 'Acesso completo para leitores a partir de 4 $ por mês',
