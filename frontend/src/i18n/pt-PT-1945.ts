...
export const PORTUGUESE_INTERFACE_PHRASES: Readonly<Record<string, string>> = {
  ...
  'African Specialist Directory': 'Directório de especialistas africanos',
  'Request a specialist': 'Solicitar um especialista',
  'Specialist dashboard': 'Painel do especialista',
  'Specialist application': 'Candidatura de especialista',
  'Application received': 'Candidatura recebida',
  'Request received': 'Pedido recebido',
  'Listing subscription': 'Subscrição de inscrição',
  'Matched requests': 'Pedidos correspondentes',
  'Confirmed opportunities': 'Oportunidades confirmadas',
  'Public biography': 'Biografia pública',
  'Credential summary': 'Resumo de credenciais',
  'Conflicts declaration': 'Declaração de conflitos',
  'Indicative pricing': 'Preços indicativos',
  'Invitation issued and emailed': 'Convite emitido e enviado por correio electrónico',
  'Invitation issued; copy the URL': 'Convite emitido; copie o endereço',
  'Review failed': 'A revisão falhou',
  'Issue single-use invitation': 'Emitir convite de utilização única',
  'Copy this URL now': 'Copie agora este endereço',
  'Primary verification': 'Verificação primária',
  'Need a screened specialist to test this market case?': 'Precisa de um especialista avaliado para testar este caso de mercado?',
  'Qualified Enterprise accounts can submit a bounded request. Other organizations can apply for Enterprise access.': 'As contas empresariais qualificadas podem apresentar um pedido delimitado. As outras organizações podem candidatar-se ao acesso empresarial.',
  'Apply for Enterprise': 'Candidatar-se ao acesso empresarial',
  'Last Updated: August 2026': 'Última actualização: Agosto de 2026',
  '4A. Specialist Marketplace': '4A. Mercado de especialistas',
  'We collect information you provide directly, including account details, briefing preferences, newsletter subscriptions, bookmarks, contact messages, pilot applications, specialist applications, public specialist profile fields, conflict declarations and Enterprise specialist requests.': 'Recolhemos as informações que fornece directamente, incluindo dados da conta, preferências de síntese, subscrições do boletim, marcadores, mensagens de contacto, candidaturas-piloto, candidaturas de especialistas, campos públicos dos perfis, declarações de conflitos e pedidos empresariais de especialistas.',
  'Approved profile names, organizations, biographies, countries, sectors, services, languages, credential summaries, reference links, indicative pricing and availability may be public. Application contact details, private screening notes, conflict details, billing identifiers and application history are not published.': 'Os nomes, organizações, biografias, países, sectores, serviços, línguas, resumos de credenciais, ligações de referência, preços indicativos e disponibilidade dos perfis aprovados podem ser públicos. Os contactos da candidatura, notas privadas de avaliação, pormenores de conflitos, identificadores de facturação e histórico da candidatura não são publicados.',
  'Stripe processes specialist listing subscriptions and receives the billing information needed for Checkout and Customer Portal. We retain only limited customer, subscription, status and webhook identifiers; we do not store complete Stripe webhook payloads. Expired invitation records are removed on a bounded schedule. Abandoned, withdrawn and rejected applications are scheduled for deletion under the stated retention date, while minimal audit and billing identifiers may be retained for security, accounting and legal purposes.': 'A Stripe processa as subscrições de inscrição dos especialistas e recebe os dados de facturação necessários ao pagamento e ao portal do cliente. Conservamos apenas identificadores limitados de cliente, subscrição, estado e webhook; não guardamos cargas completas dos webhooks da Stripe. Os registos de convites expirados são eliminados segundo um calendário delimitado. As candidaturas abandonadas, retiradas e rejeitadas são programadas para eliminação na data de conservação indicada, podendo ser conservados identificadores mínimos de auditoria e facturação para fins de segurança, contabilidade e obrigações legais.',
  'Do not provide identity documents, CV files, confidential client records or sensitive personal data through marketplace forms. You may request correction, withdrawal or deletion through the contact process below, subject to legal retention duties.': 'Não forneça documentos de identidade, ficheiros de currículo, registos confidenciais de clientes nem dados pessoais sensíveis através dos formulários do mercado. Pode solicitar correcção, retirada ou eliminação pelo processo de contacto abaixo, sem prejuízo dos deveres legais de conservação.',
  'Find practical African market expertise.': 'Encontre conhecimentos práticos sobre os mercados africanos.',
  'Profiles are screened for marketplace access. Screening is not an endorsement or a substitute for your own due diligence.': 'Os perfis são avaliados para acesso ao mercado. A avaliação não constitui recomendação nem substitui a sua própria diligência.',
  'Loading specialists…': 'A carregar especialistas…',
  'View profile': 'Ver perfil',
  'Loading profile…': 'A carregar perfil…',
  'Confirm that the application contains no sensitive information.': 'Confirme que a candidatura não contém informações sensíveis.',
  'Application failed.': 'A candidatura falhou.',
  'An administrator will screen your application. Billing begins only after approval and your explicit checkout.': 'Um administrador avaliará a sua candidatura. A facturação só começa após a aprovação e a sua confirmação expressa do pagamento.',
  'Open dashboard': 'Abrir painel',
  'Provide links and concise summaries only. Do not upload or paste identity documents, CV files, confidential client material, or other sensitive data.': 'Forneça apenas ligações e resumos concisos. Não carregue nem cole documentos de identidade, ficheiros de currículo, material confidencial de clientes ou outros dados sensíveis.',
  'Organization (optional)': 'Organização (facultativo)',
  'Countries (comma-separated)': 'Países (separados por vírgulas)',
  'Indicative pricing (optional)': 'Preços indicativos (facultativo)',
  'Availability (optional)': 'Disponibilidade (facultativo)',
  'I confirm this application contains no sensitive personal or client information, and the conflicts declaration is complete.': 'Confirmo que esta candidatura não contém informações pessoais ou de clientes sensíveis e que a declaração de conflitos está completa.',
  'Submit application': 'Apresentar candidatura',
  'Loading dashboard…': 'A carregar painel…',
  'Sign in with your specialist account.': 'Inicie sessão com a sua conta de especialista.',
  'Manage your screened specialist listing and proposals.': 'Gerir a sua inscrição de especialista avaliado e as propostas.',
  'An active listing requires approval and an active monthly subscription.': 'Uma inscrição activa exige aprovação e uma subscrição mensal activa.',
  'Submit an indicative proposal': 'Apresentar uma proposta indicativa',
  'Submit proposal': 'Apresentar proposta',
  'Confirm that the request contains no sensitive information.': 'Confirme que o pedido não contém informações sensíveis.',
  'Request failed.': 'O pedido falhou.',
  'Administrators will rank and confirm suitable active specialists before request details are shared.': 'Os administradores classificarão e confirmarão especialistas activos adequados antes de partilharem os pormenores do pedido.',
  'View request': 'Ver pedido',
  'Submit a structured specialist request for an approved Enterprise account.': 'Apresentar um pedido estruturado de especialista para uma conta empresarial aprovada.',
  'Only administrator-enabled Enterprise accounts can submit. Do not include confidential, regulated, or sensitive information.': 'Apenas contas empresariais activadas por um administrador podem apresentar pedidos. Não inclua informações confidenciais, regulamentadas ou sensíveis.',
  'Target countries (comma-separated)': 'Países visados (separados por vírgulas)',
  'Required expertise (comma-separated)': 'Especialização necessária (separada por vírgulas)',
  'Context summary (optional)': 'Resumo do contexto (facultativo)',
  'I confirm this request contains no sensitive information.': 'Confirmo que este pedido não contém informações sensíveis.',
  'Submit request': 'Apresentar pedido',
  'Loading request…': 'A carregar pedido…',
  '4. Specialist Marketplace': '4. Mercado de especialistas',
  '5. Prohibited Services': '5. Serviços proibidos',
  '6. Termination': '6. Cessação',
  'Market intelligence and specialist profiles are provided for informational purposes only and do not constitute financial, legal, tax, medical, regulatory or investment advice. Marketplace screening controls access; it is not an endorsement, warranty of credentials or guarantee of results. Clients remain responsible for due diligence and independent professional advice.': 'A inteligência de mercado e os perfis de especialistas são fornecidos apenas para fins informativos e não constituem aconselhamento financeiro, jurídico, fiscal, médico, regulamentar ou de investimento. A avaliação do mercado controla o acesso; não constitui recomendação, garantia de credenciais nem garantia de resultados. Os clientes continuam responsáveis pela diligência e pelo aconselhamento profissional independente.',
  'Approved specialists may pay one recurring Stripe subscription for an eligible public listing. The fee is for platform listing access only. BOA-Story is not a party to a later engagement and does not collect engagement fees, hold client funds, pay specialists, operate milestones, provide marketplace messaging, issue refunds for specialist work, decide disputes or host reviews in this MVP.': 'Os especialistas aprovados podem pagar uma subscrição recorrente da Stripe por uma inscrição pública elegível. A taxa destina-se apenas ao acesso à inscrição na plataforma. A BOA-Story não é parte de uma contratação posterior e não cobra honorários de contratação, não detém fundos dos clientes, não paga aos especialistas, não gere etapas, mensagens do mercado, reembolsos do trabalho, litígios ou avaliações neste produto mínimo.',
  'Specialists control whether to submit a proposal. Indicative fees and timelines are non-binding until the client and specialist enter their own separate agreement. Listing visibility requires continuing approval and an active subscription and may be suspended immediately after failed, overdue or cancelled billing.': 'Os especialistas decidem se apresentam uma proposta. Os honorários e prazos indicativos não são vinculativos até o cliente e o especialista celebrarem o seu próprio acordo. A visibilidade da inscrição exige aprovação continuada e subscrição activa, podendo ser suspensa imediatamente após facturação falhada, vencida ou cancelada.',
  'Users may not offer or request unlawful, deceptive, discriminatory, sanctioned, exploitative or unlicensed regulated services; evade anti-corruption, export, immigration, employment, privacy or professional rules; solicit confidential government or competitor information; or submit identity documents, financial account data, health data or other sensitive material through marketplace forms.': 'Os utilizadores não podem oferecer nem solicitar serviços ilícitos, enganosos, discriminatórios, sancionados, exploratórios ou regulamentados sem licença; contornar regras anticorrupção, de exportação, imigração, emprego, privacidade ou profissionais; solicitar informações confidenciais de governos ou concorrentes; nem apresentar documentos de identidade, dados de contas financeiras, dados de saúde ou outro material sensível nos formulários do mercado.',
  'We reserve the right to suspend or terminate access, screening approval, Enterprise request privileges or public listing for violation of these terms, unresolved conflicts, inaccurate representations, billing status or platform risk.': 'Reservamo-nos o direito de suspender ou cessar o acesso, a aprovação da avaliação, os privilégios de pedidos empresariais ou a inscrição pública por violação destes termos, conflitos não resolvidos, declarações inexactas, estado da facturação ou risco para a plataforma.',
  'Specialist accounts are invitation-only, screening state is checked live, and public profile data is separated from private applications.': 'As contas de especialistas exigem convite, o estado da avaliação é verificado em tempo real e os dados públicos do perfil são separados das candidaturas privadas.',
  'Stripe webhook signatures and event identifiers protect subscription updates against forgery and replay.': 'As assinaturas dos webhooks e os identificadores de eventos da Stripe protegem as actualizações de subscrições contra falsificação e repetição.',
  'Specialist listing checkout, subscription status and customer billing portal. BOA-Story stores only limited billing identifiers and status.': 'Pagamento da inscrição de especialista, estado da subscrição e portal de facturação do cliente. A BOA-Story guarda apenas identificadores e estados de facturação limitados.',
  'The specialist marketplace is disabled by default and rolls out through admin invitations, test-mode billing, directory publication, Enterprise requests and proposals.': 'O mercado de especialistas está desactivado por predefinição e é lançado por fases: convites administrativos, facturação em modo de teste, publicação do directório, pedidos empresariais e propostas.',
  'Marketplace screening is not an endorsement. Client engagement payments, payouts, chat, milestones, reviews, refunds and disputes are not platform features.': 'A avaliação do mercado não constitui recomendação. Pagamentos de contratação, desembolsos, conversação, etapas, avaliações, reembolsos e litígios não são funcionalidades da plataforma.',
  'Marketplace migration is not fully applied': 'A migração do mercado não está totalmente aplicada',
  'Marketplace is enabled but Stripe configuration is incomplete': 'O mercado está activo, mas a configuração da Stripe está incompleta',
  'Marketplace health check failed': 'A verificação de estado do mercado falhou',
  'Accept': 'Aceitar',
  'Assumptions': 'Pressupostos',
  'Credential/reference URLs (comma-separated)': 'Endereços de credenciais ou referências (separados por vírgulas)',
  'Credentials': 'Credenciais',
  'Decision deadline': 'Prazo da decisão',
  'Decline': 'Recusar',
  'Directory filters': 'Filtros do directório',
  'Entity type': 'Tipo de entidade',
  'Indicative fee': 'Honorários indicativos',
  'Indicative fee:': 'Honorários indicativos:',
  'Indicative pricing:': 'Preços indicativos:',
  'Individual': 'Pessoa singular',
  'Languages': 'Línguas',
  'Languages (comma-separated)': 'Línguas (separadas por vírgulas)',
  'Manage billing': 'Gerir facturação',
  'No active listings match these filters.': 'Nenhuma inscrição activa corresponde a estes filtros.',
  'Password (12+ characters)': 'Palavra-passe (12 ou mais caracteres)',
  'Preferred languages (comma-separated)': 'Línguas preferidas (separadas por vírgulas)',
  'Profile details': 'Pormenores do perfil',
  'Profile not found.': 'Perfil não encontrado.',
  'Proposals': 'Propostas',
  'Public headline': 'Título público',
  'Refresh': 'Actualizar',
  'Request not found.': 'Pedido não encontrado.',
  'Request title': 'Título do pedido',
  'Role/title': 'Função ou título',
  'Scope': 'Âmbito',
  'Screening': 'Avaliação',
  'Sectors': 'Sectores',
  'Sectors (comma-separated)': 'Sectores (separados por vírgulas)',
  'Services (comma-separated)': 'Serviços (separados por vírgulas)',
  'Specialist invitation': 'Convite de especialista',
  'Specialist request': 'Pedido de especialista',
  'Specialist profile': 'Perfil de especialista',
  'Start subscription': 'Iniciar subscrição',
  'Timeline': 'Prazo',
  'Timeline:': 'Prazo:',
  ...
  '· deadline': '· prazo',
  '← Specialist directory': '← Directório de especialistas',
  'Proposal could not be submitted.': 'Não foi possível apresentar a proposta.',
  'Enterprise marketplace access 1': 'Acesso empresarial ao mercado: 1',
  'Access could not be updated': 'Não foi possível actualizar o acesso',
  'Enterprise marketplace access': 'Acesso empresarial ao mercado',
  'Grant access only after confirming the client is an active Enterprise account. Suspension takes effect on the next verified request.': 'Conceda acesso apenas depois de confirmar que o cliente possui uma conta empresarial activa. A suspensão produz efeitos no pedido verificado seguinte.',
  'Grant access': 'Conceder acesso',
  'No Enterprise organizations have marketplace access.': 'Nenhuma organização empresarial tem acesso ao mercado.',
  'Market verification, 1': 'Verificação de mercado, 1',
  'Independent reporting across Africa': 'Cobertura independente em toda a África',
  'Know what is shaping Africa today.': 'Saiba o que está a moldar África hoje.',
  'Start with the daily Briefing, then follow source-attributed stories, countries and research across the continent.': 'Comece pela Síntese diária e acompanhe depois histórias atribuídas às fontes, países e pesquisa em todo o continente.',
  'Open the Briefing': 'Abrir a Síntese',
  'Browse Stories': 'Explorar histórias',
  'Read story: 1': 'Ler história: 1',
  'Current reporting': 'Cobertura actual',
  'Go beyond the headline': 'Vá além do título',
  'Follow the story into country context and research.': 'Acompanhe a história até ao contexto nacional e à pesquisa.',
  'Move from current reporting to country records and official market evidence without leaving the reader journey.': 'Passe da cobertura actual para registos nacionais e evidência oficial de mercado sem sair do percurso de leitura.',
  'Explore Countries': 'Explorar países',
  'Open Research': 'Abrir pesquisa',
  'A concise view of the developments shaping Africa now.': 'Uma visão concisa dos acontecimentos que estão a moldar África.',
  'Source-attributed reporting with the context behind the headline.': 'Cobertura atribuída às fontes com o contexto por detrás do título.',
  'Open client workspace': 'Abrir espaço do cliente',
  'That email and password do not match an active account. Check both fields and try again.': 'Esse endereço de correio electrónico e essa palavra-passe não correspondem a uma conta activa. Verifique ambos os campos e tente novamente.',
  'This account is currently deactivated. Ask your BOA-Story contact for help.': 'Esta conta está actualmente desactivada. Peça ajuda ao seu contacto da BOA-Story.',
  'This account has expired. Ask your BOA-Story contact to renew access.': 'Esta conta expirou. Peça ao seu contacto da BOA-Story que renove o acesso.',
  'Enterprise access': 'Acesso empresarial',
  'Secure password access to the private BOA-Story marketplace.': 'Acesso seguro por palavra-passe ao mercado privado da BOA-Story.',
  'Sign in to your specialist workspace': 'Inicie sessão no seu espaço de especialista',
  'Access your Enterprise workspace': 'Aceda ao seu espaço empresarial',
  'Use the work email and password created from your invitation.': 'Utilize o endereço profissional e a palavra-passe criados a partir do convite.',
  'Use the password credentials issued for your approved Enterprise account.': 'Utilize as credenciais emitidas para a sua conta empresarial aprovada.',
  'Verifying access…': 'A verificar o acesso…',
  'Invitation not redeemed? Use the private link in your invitation email.': 'Ainda não utilizou o convite? Use a ligação privada na mensagem de convite.',
  'Need Enterprise access?': 'Precisa de acesso empresarial?',
  'Verifying your marketplace access…': 'A verificar o seu acesso ao mercado…',
  'Marketplace access required': 'É necessário acesso ao mercado',
  'Enterprise marketplace access status.': 'Estado do acesso empresarial ao mercado.',
  'Enterprise marketplace access is not active': 'O acesso empresarial ao mercado não está activo',
  'Specialist requests are available to approved Enterprise organizations.': 'Os pedidos de especialistas estão disponíveis para organizações empresariais aprovadas.',
  'Your organization’s marketplace access is suspended. Contact your BOA-Story administrator before submitting or reviewing requests.': 'O acesso da sua organização ao mercado está suspenso. Contacte o administrador da BOA-Story antes de apresentar ou analisar pedidos.',
  'Your Enterprise account is signed in, but an administrator has not enabled specialist marketplace access yet.': 'A sua conta empresarial tem sessão iniciada, mas um administrador ainda não activou o acesso ao mercado de especialistas.',
  'Contact the Enterprise team': 'Contactar a equipa empresarial',
  'Narrow the directory': 'Restringir o directório',
  'The directory is just getting started': 'O directório está a começar',
  'No active listings match every selected filter. Remove a filter or reset the search.': 'Nenhuma inscrição activa corresponde a todos os filtros seleccionados. Remova um filtro ou reponha a pesquisa.',
  'Approved, subscribed specialists will appear here as the marketplace launches.': 'Os especialistas aprovados e com subscrição aparecerão aqui à medida que o mercado for lançado.',
  'Loading specialist profile…': 'A carregar o perfil do especialista…',
  'BOA-Story confirms marketplace screening and listing status only. Your organization remains responsible for diligence and engagement terms.': 'A BOA-Story confirma apenas a avaliação do mercado e o estado da inscrição. A sua organização continua responsável pela diligência e pelos termos da contratação.',
  'Enter your name and a password of at least 12 characters.': 'Introduza o seu nome e uma palavra-passe com pelo menos 12 caracteres.',
  'Complete every required public-profile field. Biography must be at least 80 characters.': 'Preencha todos os campos obrigatórios do perfil público. A biografia deve ter pelo menos 80 caracteres.',
  'Add a credential summary and conflicts declaration.': 'Acrescente um resumo de credenciais e uma declaração de conflitos.',
  'This guided application creates your account and prospective public listing. Provide links and concise summaries only—never identity documents, CV files, confidential client material, or other sensitive data.': 'Esta candidatura guiada cria a sua conta e a futura inscrição pública. Forneça apenas ligações e resumos concisos — nunca documentos de identidade, ficheiros de currículo, material confidencial de clientes ou outros dados sensíveis.',
  'Account and identity': 'Conta e identidade',
  'Role/title (optional)': 'Função ou título (facultativo)',
  'Credentials and conflicts': 'Credenciais e conflitos',
  'Review and submit': 'Rever e apresentar',
  'Loading specialist dashboard…': 'A carregar o painel do especialista…',
  'Checkout completed. Stripe confirmation may take a moment; refresh to see the active status.': 'O pagamento foi concluído. A confirmação da Stripe pode demorar; actualize para ver o estado activo.',
  'Checkout was cancelled. Your card was not charged and you can return when ready.': 'O pagamento foi cancelado. O cartão não foi debitado e pode voltar quando estiver pronto.',
  'Current step': 'Etapa actual',
  'The review team needs more information. Reply to your screening contact before approval can continue.': 'A equipa de avaliação precisa de mais informações. Responda ao seu contacto de avaliação para que a aprovação possa prosseguir.',
  'Screening is separate from billing and public listing.': 'A avaliação é distinta da facturação e da inscrição pública.',
  'Billing becomes available after approval. You will never be charged for applying.': 'A facturação fica disponível após a aprovação. Nunca será cobrado pela candidatura.',
  'Payment needs attention. Open billing to update the payment method.': 'O pagamento requer atenção. Abra a facturação para actualizar o método de pagamento.',
  'Start the monthly subscription when you are ready to make the approved profile eligible for listing.': 'Inicie a subscrição mensal quando estiver pronto para tornar o perfil aprovado elegível para inscrição.',
  'Matches are reviewed before sharing. Keep your profile current; there is nothing you need to submit until an opportunity appears here.': 'As correspondências são revistas antes da partilha. Mantenha o perfil actualizado; não precisa de apresentar nada até surgir aqui uma oportunidade.',
  'Proposal submitted. The Enterprise requester can now review it. You will see any lifecycle change after refreshing this workspace.': 'Proposta apresentada. O requerente empresarial já pode analisá-la. Verá qualquer alteração de estado depois de actualizar este espaço.',
  'This opportunity is': 'Esta oportunidade está',
  'and no proposal action is available.': 'e não está disponível nenhuma acção sobre a proposta.',
  'Keep the information used for matching and your public listing current.': 'Mantenha actualizadas as informações utilizadas para correspondência e para a inscrição pública.',
  'Save profile': 'Guardar perfil',
  'Set scope boundaries and assumptions clearly. The requester will still complete its own diligence and contracting.': 'Defina claramente os limites do âmbito e os pressupostos. O requerente continuará a realizar a sua própria diligência e contratação.',
  'Proposal submitted and the opportunity status has been refreshed.': 'A proposta foi apresentada e o estado da oportunidade foi actualizado.',
  'Loading your specialist requests…': 'A carregar os seus pedidos de especialistas…',
  'Track scoped requests and review proposals shared by confirmed specialists.': 'Acompanhe pedidos delimitados e analise propostas partilhadas por especialistas confirmados.',
  'Create a bounded decision request when specialist verification would help your team move forward.': 'Crie um pedido de decisão delimitado quando a verificação por um especialista puder ajudar a sua equipa a avançar.',
  'Open request': 'Abrir pedido',
  'Specialist support: 1': 'Apoio de especialista: 1',
  'Frame one decision and the expertise needed to verify it. Do not include confidential, regulated, or sensitive information.': 'Formule uma decisão e a especialização necessária para a verificar. Não inclua informações confidenciais, regulamentadas ou sensíveis.',
  'We prefilled this request from the market workspace or specialist profile. Review every field before submitting.': 'Preenchemos previamente este pedido a partir do espaço de mercado ou do perfil do especialista. Reveja todos os campos antes de o apresentar.',
  'Confirm the data boundary before submitting.': 'Confirme os limites dos dados antes de apresentar.',
  'Loading specialist request…': 'A carregar o pedido de especialista…',
  'Current status': 'Estado actual',
  'Required expertise': 'Especialização necessária',
  'Administrators first rank and confirm eligible specialists. Return here when the request reaches “Proposals ready.”': 'Os administradores começam por classificar e confirmar os especialistas elegíveis. Volte aqui quando o pedido atingir o estado «Propostas prontas».',
  'Review public profile': 'Analisar perfil público',
  'Updating proposal and refreshing the request…': 'A actualizar a proposta e o pedido…',
  'Pesquisa': 'Pesquisa',
  'Enterprise sign in': 'Início de sessão empresarial',
  'Existing Enterprise client sign in': 'Início de sessão de cliente empresarial existente',
  'Enterprise Marketplace': 'Mercado empresarial',
  'Password': 'Palavra-passe',
  'Return to Enterprise': 'Voltar à área empresarial',
  'Sign in securely': 'Iniciar sessão em segurança',
  'Specialist sign in': 'Início de sessão de especialista',
  ...
  'Credential links (comma-separated)': 'Ligações de credenciais (separadas por vírgulas)',
  'Credential or reference': 'Credencial ou referência',
  'Dashboard could not be loaded.': 'Não foi possível carregar o painel.',
  'Display name': 'Nome de apresentação',
  'Edit profile': 'Editar perfil',
  'Enterprise sign in to request': 'Início de sessão empresarial para solicitar',
  'Enterprise workspace': 'Espaço empresarial',
  'Headline': 'Título',
  'Independent': 'Independente',
  'Independent specialist': 'Especialista independente',
  'Listing lifecycle': 'Ciclo da inscrição',
  'Markets': 'Mercados',
  'New request': 'Novo pedido',
  'No confirmed opportunities yet': 'Ainda não há oportunidades confirmadas',
  'No proposals are ready yet.': 'Ainda não há propostas prontas.',
  'No requests yet': 'Ainda não há pedidos',
  'Not specified': 'Não especificado',
  'Only administrator-confirmed matches appear here.': 'Apenas aparecem aqui correspondências confirmadas por um administrador.',
  'Opening billing…': 'A abrir a facturação…',
  'Private specialist workspace': 'Espaço privado do especialista',
  'Prospective public profile': 'Futuro perfil público',
  'Public biography (80+ characters)': 'Biografia pública (80 ou mais caracteres)',
  'Public profile': 'Perfil público',
  'Refresh status': 'Actualizar estado',
  'Request status timeline': 'Cronologia do estado do pedido',
  'Reset all': 'Repor tudo',
  'Reset filters': 'Repor filtros',
  'Retry inbox': 'Voltar a carregar a caixa de pedidos',
  'Saving profile…': 'A guardar o perfil…',
  'Searching directory…': 'A pesquisar o directório…',
  'Specialist requests': 'Pedidos de especialistas',
  'Start a scoped request': 'Iniciar um pedido delimitado',
  'Submitting application…': 'A apresentar a candidatura…',
  'Submitting proposal…': 'A apresentar a proposta…',
  'Submitting request…': 'A apresentar o pedido…',
  'Upcoming': 'Próximo',
  'Welcome,': 'Bem-vindo,',
  '← Request inbox': '← Caixa de pedidos',
  '✓ Complete': '✓ Concluído',
  'Professional pathways': 'Percursos profissionais',
  'Application could not be submitted.': 'Não foi possível apresentar a candidatura.',
  'Your account does not have access to this marketplace view.': 'A sua conta não tem acesso a esta vista do mercado.',
  'This marketplace record is unavailable or no longer published.': 'Este registo do mercado não está disponível ou deixou de estar publicado.',
  'The marketplace is temporarily unavailable. Please try again.': 'O mercado está temporariamente indisponível. Tente novamente.',
  ...
  'profile-': 'perfil-',
  'scope-': 'âmbito-',
  'specialist found': 'especialista encontrado',
  'through': 'até',
  'timeline-': 'prazo-',
  'Read story:': 'Ler história:',
  '[dynamic] assumptions-': '[dinâmico] pressupostos-',
  '[dynamic] fee-': '[dinâmico] honorários-',
  '[dynamic] filter-': '[dinâmico] filtro-',
  '[dynamic] scope-': '[dinâmico] âmbito-',
  '[dynamic] timeline-': '[dinâmico] prazo-',
  '[dynamic] — African specialist': '[dinâmico] — especialista africano',
  'Direct acquisition health': 'Estado da aquisição directa',
  'Direct sources productive': 'Fontes directas produtivas',
  'Official country acquisition': 'Aquisição nacional oficial',
  'Official country lanes': 'Canais nacionais oficiais',
  'Country lanes productive': 'Canais nacionais produtivos',
  'Primary/global productive': 'Fontes primárias ou globais produtivas',
  'countries with a direct provider lane': 'países com um canal directo do fornecedor',
  'supplied qualifying evidence in 30 days': 'forneceram evidência elegível em 30 dias',
  'authoritative source lanes': 'canais de fontes de referência',
  'measured output, not catalogue size': 'produção medida, não dimensão do catálogo',
  ...
  'Progress': 'Progresso',
  'Working…': 'A processar…',
  'Nothing here yet': 'Ainda não há conteúdo',
  'We could not load this view': 'Não foi possível carregar esta vista',
  'Please try again.': 'Tente novamente.',
  'Please check the form': 'Verifique o formulário',
  ...
  'Primary-data profiles and portals with recorded provenance. Legacy links without editorial verification are not shown.':
    'Perfis de dados primários e portais cuja proveniência foi registada. As ligações antigas sem verificação editorial não são apresentadas.',
  'official country dataset': 'conjunto oficial de dados nacionais',
  'verified official portal': 'portal oficial verificado',
  'Fonte primária verificada': 'Fonte primária verificada',
  ...
  'Interest marked for review': 'Interesse marcado para análise',
  'Interest record could not be updated': 'Não foi possível actualizar o registo de interesse',
  'Review demand-aligned expertise before issuing a single-use application invitation.': 'Analise a especialização adequada à procura antes de emitir um convite de candidatura de utilização única.',
  'Review for demand fit': 'Analisar adequação à procura',
  'We collect information you provide directly, including account details, briefing preferences, newsletter subscriptions, bookmarks, contact messages, pilot applications, specialist interest registrations, invited specialist applications, public specialist profile fields, conflict declarations and Enterprise specialist requests.': 'Recolhemos informações que fornece directamente, incluindo dados de conta, preferências de síntese, subscrições de boletins, artigos guardados, mensagens de contacto, candidaturas a projectos-piloto, registos de interesse de especialistas, candidaturas de especialistas convidados, campos públicos dos perfis de especialistas, declarações de conflitos e pedidos empresariais de especialistas.',
  'A specialist interest registration is a separate, non-public record used to assess possible fit with emerging Enterprise demand. It does not create an account or application. Registrations include the professional details submitted through the form and are retained for no more than 24 months unless deletion is requested earlier or a legal duty requires retention.': 'O registo de interesse de um especialista é um registo separado e não público, utilizado para avaliar uma possível adequação à procura empresarial emergente. Não cria uma conta nem uma candidatura. Os registos incluem os dados profissionais apresentados no formulário e são conservados durante, no máximo, 24 meses, salvo pedido de eliminação anterior ou obrigação legal de conservação.',
  'Join the specialist waitlist': 'Inscrever-se na lista de interesse de especialistas',
  'Add at least one country, sector, service, and working language.': 'Acrescente pelo menos um país, sector, serviço e língua de trabalho.',
  'Confirm that your registration contains no sensitive personal or client information.': 'Confirme que o registo não contém informações pessoais sensíveis nem informações sensíveis de clientes.',
  'Your interest could not be registered.': 'Não foi possível registar o seu interesse.',
  'Your interest in the BOA Specialist Network has been registered.': 'O seu interesse na Rede de Especialistas da BOA foi registado.',
  'Your interest is registered.': 'O seu interesse foi registado.',
  'BOA reviews the registry against emerging Enterprise needs. If your expertise is relevant, the team may send a separate, single-use invitation to complete screening. Registration is not an application or a promise of admission or work.': 'A BOA analisa o registo em função das necessidades empresariais emergentes. Se a sua especialização for pertinente, a equipa poderá enviar um convite separado e de utilização única para concluir a avaliação. O registo não é uma candidatura nem uma promessa de admissão ou de trabalho.',
  'Return to the directory': 'Voltar ao directório',
  'Join the BOA Specialist Network waitlist': 'Inscrever-se na lista de interesse da Rede de Especialistas da BOA',
  'Register your interest in being considered for the invite-only BOA Specialist Network.': 'Registe o seu interesse em ser considerado para a Rede de Especialistas da BOA, reservada a convidados.',
  'Interested in joining the BOA Specialist Network?': 'Tem interesse em integrar a Rede de Especialistas da BOA?',
  'Register your interest. Selected specialists may be invited to complete our screening process when their expertise aligns with Enterprise needs.': 'Registe o seu interesse. Os especialistas seleccionados poderão ser convidados a concluir o nosso processo de avaliação quando a sua especialização corresponder às necessidades empresariais.',
  'How entry works': 'Como funciona a entrada',
  '1. Register interest': '1. Registar interesse',
  '2. BOA reviews demand and fit': '2. A BOA analisa a procura e a adequação',
  '4. Screening precedes network access': '4. A avaliação antecede o acesso à rede',
  'Express your interest': 'Manifeste o seu interesse',
  'Use concise professional information only. Do not submit identity documents, CV files, confidential records, or client information.': 'Utilize apenas informações profissionais concisas. Não apresente documentos de identidade, ficheiros de currículo, registos confidenciais nem informações de clientes.',
  'Role or professional title (optional)': 'Função ou título profissional (facultativo)',
  'Countries of expertise': 'Países de especialização',
  'How could your expertise help Enterprise teams?': 'Como poderá a sua especialização ajudar equipas empresariais?',
  'I confirm this registration contains no sensitive personal or client information. I understand it is not an application, admission, endorsement, or promise of work.': 'Confirmo que este registo não contém informações pessoais sensíveis nem informações sensíveis de clientes. Compreendo que não constitui candidatura, admissão, recomendação nem promessa de trabalho.',
  'Register interest': 'Registar interesse',
  'Why the network is invite-only': 'Por que razão a rede exige convite',
  'BOA recruits around real Enterprise needs, geographic coverage, sectors, services, and languages. This keeps screening focused and avoids listing specialists before relevant demand exists.': 'A BOA recruta em função de necessidades empresariais reais, cobertura geográfica, sectores, serviços e línguas. Esta abordagem mantém a avaliação focalizada e evita inscrever especialistas antes de existir procura pertinente.',
  'Screening is a marketplace access review, not an endorsement. Approved specialists still control independent contracting and delivery.': 'A avaliação é uma análise de acesso ao mercado, não uma recomendação. Os especialistas aprovados continuam a controlar a contratação e a prestação independentes.',
  'Read the privacy policy': 'Ler a política de privacidade',
  'The public interest registry is not an application, account, endorsement, admission decision or promise of work. BOA-Story may use registry information to identify expertise relevant to emerging Enterprise needs. Only selected specialists receive a separate, single-use invitation to apply, and every invited application remains subject to screening.': 'O registo público de interesse não constitui candidatura, conta, recomendação, decisão de admissão nem promessa de trabalho. A BOA-Story pode utilizar as informações do registo para identificar especializações pertinentes para necessidades empresariais emergentes. Apenas os especialistas seleccionados recebem um convite separado e de utilização única para se candidatarem, e todas as candidaturas por convite continuam sujeitas a avaliação.',
  'Specialist applications remain invitation-only; the public interest registry creates no account and public profile data is separated from private screening records.': 'As candidaturas de especialistas continuam reservadas a convidados; o registo público de interesse não cria qualquer conta e os dados públicos do perfil são separados dos registos privados de avaliação.',
  'Articles, sources, country records, preferences, account records, specialist interest registrations, audit history and operational metadata.': 'Artigos, fontes, registos nacionais, preferências, registos de contas, registos de interesse de especialistas, histórico de auditoria e metadados operacionais.',
  'The public interest registry supports controlled specialist discovery; applications still require a single-use administrator invitation and screening.': 'O registo público de interesse permite a descoberta controlada de especialistas; as candidaturas continuam a exigir um convite de utilização única emitido por um administrador e uma avaliação.',
  '3. Selected specialists receive an invitation': '3. Os especialistas seleccionados recebem um convite',
  'Express interest in joining': 'Manifestar interesse em aderir',
  'Interest registered': 'Interesse registado',
  'Profile type': 'Tipo de perfil',
  'Countries of expertise (comma-separated)': 'Países de especialização (separados por vírgulas)',
  'Working languages': 'Línguas de trabalho',
  'Working languages (comma-separated)': 'Línguas de trabalho (separadas por vírgulas)',
  'Specialist standing and listing access updated': 'Nível do especialista e acesso à inscrição actualizados',
  'Specialist standing could not be updated': 'Não foi possível actualizar o nível do especialista',
  'These counts come from active Enterprise requests. Recruit against repeated country, sector, language, and service needs before expanding unrelated supply.': 'Estas contagens provêm de pedidos empresariais activos. Recrute em função de necessidades recorrentes de país, sector, língua e serviço antes de alargar uma oferta sem relação com a procura.',
  'Applications and network standing': 'Candidaturas e níveis na rede',
  'Founding membership is capped at 50. Verification reflects reviewed evidence, never payment.': 'A participação fundadora está limitada a 50 membros. A verificação reflecte provas analisadas, nunca o pagamento.',
  'Verification and listing access': 'Verificação e acesso à inscrição',
  'Document the public basis for elevated standing. Founding specialists automatically receive a listing-fee waiver.': 'Documente a base pública para um nível superior. Os especialistas fundadores recebem automaticamente uma isenção da taxa de inscrição.',
  'Waiver end date (optional)': 'Data de termo da isenção (facultativa)',
  'Public verification evidence summary': 'Resumo público das provas de verificação',
  'Documented experience, references, credentials, and relevant BOA delivery evidence reviewed.': 'Experiência documentada, referências, credenciais e provas pertinentes de trabalhos da BOA analisadas.',
  'Save standing': 'Guardar nível',
  'Approved profile names, organizations, biographies, countries, sectors, services, languages, credential summaries, reference links, indicative pricing, availability, founding-cohort status, verification level and the public evidence summary supporting that level may be public. Application contact details, private screening notes, conflict details, billing or waiver administration and application history are not published.': 'Os nomes, organizações, biografias, países, sectores, serviços, línguas, resumos de credenciais, ligações de referência, preços indicativos, disponibilidade, pertença ao grupo fundador, nível de verificação e resumo público das provas que sustentam esse nível dos perfis aprovados podem ser públicos. Os contactos da candidatura, notas privadas de avaliação, dados sobre conflitos, administração de facturação ou isenções e histórico da candidatura não são publicados.',
  'Founding specialists may receive waived listing access without providing payment information. Where a later paid listing arrangement applies, Stripe processes the subscription and receives the billing information needed for Checkout and Customer Portal. We retain only limited customer, subscription, waiver, status and webhook identifiers; we do not store complete Stripe webhook payloads. Expired invitation records are removed on a bounded schedule. Abandoned, withdrawn and rejected applications are scheduled for deletion under the stated retention date, while minimal audit and billing identifiers may be retained for security, accounting and legal purposes.': 'Os especialistas fundadores podem receber acesso gratuito à inscrição sem fornecer dados de pagamento. Quando se aplicar posteriormente um regime de inscrição pago, a Stripe processa a subscrição e recebe os dados de facturação necessários para o Checkout e o Portal do Cliente. Conservamos apenas identificadores limitados de cliente, subscrição, isenção, estado e webhook; não guardamos conteúdos integrais dos webhooks da Stripe. Os convites expirados são removidos segundo um calendário limitado. As candidaturas abandonadas, retiradas e rejeitadas são programadas para eliminação na data de conservação indicada, podendo ser conservados identificadores mínimos de auditoria e facturação para fins de segurança, contabilidade e obrigações legais.',
  'Screened for network access using submitted professional evidence.': 'Avaliado para acesso à rede com base nas provas profissionais apresentadas.',
  'Stronger documented standing and relevant delivery history; never awarded through payment.': 'Posição documentada mais sólida e histórico de trabalho pertinente; nunca atribuída mediante pagamento.',
  'BOA is deliberately building a selective Founding Specialist Network of roughly 20–50 credible professionals, then recruiting around real Enterprise needs, geographic coverage, sectors, services, and languages.': 'A BOA está a formar deliberadamente uma Rede Fundadora de Especialistas selectiva, com cerca de 20 a 50 profissionais credíveis, recrutando depois em função de necessidades empresariais reais, cobertura geográfica, sectores, serviços e línguas.',
  'Founding specialists receive waived listing access while BOA proves repeatable demand. Verification standing depends on documented evidence and relevant experience—not payment.': 'Os especialistas fundadores recebem acesso gratuito à inscrição enquanto a BOA demonstra uma procura repetível. O nível de verificação depende de provas documentadas e experiência pertinente — não do pagamento.',
  'Listing access active': 'Acesso à inscrição activo',
  'Listing access': 'Acesso à inscrição',
  'Founding access waived': 'Acesso fundador isento',
  'BOA has waived your listing fee1. No payment is required for listing access.': 'A BOA isentou a sua taxa de inscrição1. Não é necessário qualquer pagamento para aceder à inscrição.',
  'during the founding-network stage': 'durante a fase da rede fundadora',
  'Listing arrangements are confirmed only after approval. You will never be charged for applying.': 'As condições de inscrição só são confirmadas após a aprovação. Nunca será cobrado pela candidatura.',
  'BOA will confirm a founding waiver or later billing arrangement before your profile is listed.': 'A BOA confirmará uma isenção fundadora ou um regime de facturação posterior antes de o seu perfil ser publicado.',
  'Open listing options': 'Abrir opções de inscrição',
  'Founding specialists may receive free, waived listing access while BOA-Story validates repeatable Enterprise demand. A waiver does not create an entitlement to opportunities and payment never purchases verification standing. If a later recurring Stripe listing arrangement applies, its fee is for platform listing access only.': 'Os especialistas fundadores podem receber acesso gratuito à inscrição enquanto a BOA-Story valida uma procura empresarial repetível. Uma isenção não confere direito a oportunidades e o pagamento nunca permite adquirir um nível de verificação. Se posteriormente se aplicar uma inscrição recorrente pela Stripe, a respectiva taxa destina-se apenas ao acesso à inscrição na plataforma.',
  'BOA-Story is not a party to a later engagement and does not collect percentage commissions or engagement fees, hold client funds, pay specialists, operate milestones, provide marketplace messaging, issue refunds for specialist work, decide disputes or host reviews in this MVP.': 'A BOA-Story não é parte numa contratação posterior e não cobra comissões percentuais nem taxas de contratação, não detém fundos de clientes, não paga a especialistas, não gere etapas, não fornece mensagens no mercado, não emite reembolsos por trabalho de especialistas, não decide litígios nem aloja avaliações neste produto mínimo viável.',
  'Specialists control whether to submit a proposal. Indicative fees and timelines are non-binding until the client and specialist enter their own separate agreement. Listing visibility requires continuing approval plus a current BOA listing waiver or active subscription and may be suspended when either basis expires.': 'Os especialistas decidem se apresentam uma proposta. Os honorários e prazos indicativos não são vinculativos até o cliente e o especialista celebrarem um acordo separado. A visibilidade da inscrição exige aprovação contínua e uma isenção vigente da BOA ou uma subscrição activa, podendo ser suspensa quando qualquer destas bases expirar.',
  'Specialist standing is based on reviewed experience, references, credentials and relevant delivery evidence; payment cannot purchase a verification level.': 'O nível do especialista baseia-se em experiência, referências, credenciais e provas de trabalho pertinentes que foram analisadas; o pagamento não permite adquirir um nível de verificação.',
  'The Founding Specialist Network is capped at 50 profiles, receives waived listing access, and expands in response to active Enterprise demand signals.': 'A Rede Fundadora de Especialistas está limitada a 50 perfis, recebe acesso gratuito à inscrição e expande-se em resposta a sinais de procura empresarial activa.',
  'BOA Specialist, Verified Specialist, and Senior / Featured Specialist standing is evidence-based and independent of billing.': 'Os níveis Especialista BOA, Especialista Verificado e Especialista Sénior / em Destaque baseiam-se em provas e são independentes da facturação.',
  'Additional documented experience, references, or professional credentials reviewed.': 'Experiência documentada, referências ou credenciais profissionais adicionais analisadas.',
  'BOA Specialist': 'Especialista BOA',
  'BOA verification basis': 'Base da verificação da BOA',
  'Founding Specialist': 'Especialista fundador',
  'Founding Specialist Network': 'Rede Fundadora de Especialistas',
  'Listing requires approval plus a BOA waiver or an active subscription. Payment never determines verification standing.': 'A inscrição exige aprovação e uma isenção da BOA ou uma subscrição activa. O pagamento nunca determina o nível de verificação.',
  'Senior / Featured Specialist': 'Especialista sénior / em destaque',
  'Specialist verification hierarchy': 'Hierarquia de verificação dos especialistas',
  'Verified Specialist': 'Especialista verificado',
  'BOA has waived your listing fee . No payment is required for listing access.': 'A BOA isentou a sua taxa de inscrição. Não é necessário qualquer pagamento para aceder à inscrição.',
  'Record a membership review reason before deciding': 'Registe uma justificação da revisão da adesão antes de decidir',
  'Nothing reaches the public knowledge network until a human checks evidence, confidentiality, attribution and disclosure.': 'Nada chega à rede pública de conhecimento antes de uma pessoa verificar as provas, a confidencialidade, a atribuição e as declarações de interesses.',
  'Loading pending contributions…': 'A carregar contributos pendentes…',
  'Required moderation record': 'Registo obrigatório de moderação',
  'Evidence checked, privacy boundary, corrections required, or reason for rejection.': 'Provas verificadas, limite de privacidade, correcções necessárias ou motivo da rejeição.',
  'Approve and publish': 'Aprovar e publicar',
  'No knowledge contributions are awaiting review.': 'Não há contributos de conhecimento a aguardar revisão.',
  'Approve specialists only where their submitted experience supports the circle. Membership affects standing inside that circle, not verification elsewhere.': 'Aprove especialistas apenas quando a experiência apresentada sustente a participação no círculo. A adesão afecta o estatuto nesse círculo, não a verificação noutros espaços.',
  'Loading membership requests…': 'A carregar pedidos de adesão…',
  'Pending review': 'Revisão pendente',
  'Required private review record': 'Registo privado obrigatório da revisão',
  'Evidence reviewed, scope approved, or reason for rejection.': 'Provas analisadas, âmbito aprovado ou motivo da rejeição.',
  'No circle memberships are awaiting review.': 'Não há adesões a círculos a aguardar revisão.',
  'The public knowledge network': 'A rede pública de conhecimento',
  'Read the wisdom around the evidence.': 'Leia o conhecimento que dá contexto às provas.',
  'Reviewed reader questions, specialist explanations, evidence challenges and consented Enterprise learning connect reporting to practical experience without turning popularity into authority.': 'Perguntas de leitores, explicações de especialistas, contestações de provas e aprendizagens empresariais consentidas ligam a informação à experiência prática, após revisão, sem transformar popularidade em autoridade.',
  'Explore knowledge circles': 'Explorar círculos de conhecimento',
  'Enterprise buyer groups and public learning': 'Grupos de compradores empresariais e aprendizagem pública',
  'Companies, investors, public institutions, advisers and African or diaspora business networks now have explicit communities for reviewed questions, specialist explanations and consented learning. Private client work remains private.': 'Empresas, investidores, instituições públicas, consultores e redes empresariais africanas ou da diáspora dispõem agora de comunidades próprias para perguntas revistas, explicações de especialistas e aprendizagens consentidas. O trabalho privado de clientes permanece privado.',
  'Open Enterprise communities': 'Abrir comunidades empresariais',
  'Evidence challenge': 'Contestação de provas',
  'Country perspective': 'Perspectiva nacional',
  'Source-linked analysis': 'Análise ligada às fontes',
  'Open question': 'Pergunta em aberto',
  'Ask the circle': 'Perguntar ao círculo',
  'Sign in before submitting a moderated public question. Reading remains open.': 'Inicie sessão antes de enviar uma pergunta pública sujeita a moderação. A leitura permanece aberta.',
  'Contribute to this circle': 'Contribuir para este círculo',
  'Every submission receives human review before publication.': 'Todas as submissões recebem revisão humana antes da publicação.',
  'Source links (comma-separated)': 'Ligações às fontes (separadas por vírgulas)',
  'Required for field signals and evidence challenges.': 'Obrigatórias para sinais de terreno e contestações de provas.',
  'Relevant conflict or commercial relationship (optional)': 'Conflito ou relação comercial relevante (facultativo)',
  'I confirm this contains no confidential, regulated, personal or material non-public information and may be reviewed for public publication.': 'Confirmo que isto não contém informação confidencial, regulamentada, pessoal ou material não pública e que pode ser revisto para publicação pública.',
  'Submission failed.': 'A submissão falhou.',
  'Contribution received for human review. It is not public yet.': 'Contributo recebido para revisão humana. Ainda não é público.',
  'Submitting for review…': 'A enviar para revisão…',
  'Submit for review': 'Enviar para revisão',
  'Circle membership is pending human review.': 'A adesão ao círculo aguarda revisão humana.',
  'Why your documented experience fits this circle': 'Explique por que razão a sua experiência documentada se adequa a este círculo',
  'Membership is evidence-reviewed. Payment and popularity cannot approve it.': 'A adesão é avaliada com base em provas. O pagamento e a popularidade não podem determiná-la.',
  'Request review': 'Pedir revisão',
  'Submit a reviewed response': 'Enviar uma resposta para revisão',
  'Your response appears only after human review and remains linked to the contribution above.': 'A sua resposta só aparece depois de revisão humana e permanece ligada ao contributo acima.',
  'Supporting source links (comma-separated)': 'Ligações de apoio às fontes (separadas por vírgulas)',
  'Show my approved public identity where my account permits it.': 'Mostrar a minha identidade pública aprovada quando a minha conta o permitir.',
  'I confirm this contains no confidential, regulated, personal or material non-public information.': 'Confirmo que isto não contém informação confidencial, regulamentada, pessoal ou material não pública.',
  'Mark this contribution useful': 'Marcar este contributo como útil',
  'Loading knowledge circles…': 'A carregar círculos de conhecimento…',
  'Latest across the network': 'Mais recentes em toda a rede',
  'Open the complete network': 'Abrir a rede completa',
  'Loading reviewed contributions…': 'A carregar contributos revistos…',
  'The circle is open for its first reviewed contribution': 'O círculo está aberto ao primeiro contributo revisto',
  'BOA publishes real attributed knowledge only after review. Questions may be submitted now; empty activity is never replaced with invented participation.': 'A BOA só publica conhecimento real e atribuído depois de revisão. As perguntas podem ser enviadas desde já; uma actividade vazia nunca é substituída por participação inventada.',
  'Questions, explanations and field perspectives': 'Perguntas, explicações e perspectivas do terreno',
  'Public contributions add accountable professional context without changing the underlying official record or BOA reporting.': 'Os contributos públicos acrescentam contexto profissional responsabilizável sem alterar o registo oficial subjacente nem a informação da BOA.',
  'Explore all circles': 'Explorar todos os círculos',
  'Moderated, evidence-linked questions and perspectives from BOA-Story readers, Enterprise participants and screened specialists.': 'Perguntas e perspectivas moderadas e ligadas a provas, apresentadas por leitores da BOA-Story, participantes empresariais e especialistas avaliados.',
  'Bring market questions into a documented professional community.': 'Leve as perguntas de mercado a uma comunidade profissional documentada.',
  'Make specialist knowledge visible, useful and accountable.': 'Torne o conhecimento especializado visível, útil e responsabilizável.',
  'Follow explicit regional, sector, professional and decision groups. Read reviewed contributions, ask bounded questions and trace what is evidence, interpretation or professional experience.': 'Siga grupos regionais, sectoriais, profissionais e de decisão claramente definidos. Leia contributos revistos, formule perguntas delimitadas e distinga provas, interpretação e experiência profissional.',
  'Human review before publication': 'Revisão humana antes da publicação',
  'Role and evidence labels': 'Rótulos de função e de base probatória',
  'Approved contributions may be read throughout BOA-Story and connected to relevant countries, sectors and intelligence pages.': 'Os contributos aprovados podem ser lidos em toda a BOA-Story e ligados aos países, sectores e páginas de inteligência pertinentes.',
  'Enterprise requests, commercial details and private workspace discussions never enter the public feed automatically.': 'Os pedidos empresariais, os pormenores comerciais e as discussões privadas do espaço de trabalho nunca entram automaticamente no fluxo público.',
  'Payment, popularity and follower counts never purchase screening or verification standing.': 'O pagamento, a popularidade e o número de seguidores nunca compram avaliação nem estatuto de verificação.',
  'Regional, sector and professional circles.': 'Círculos regionais, sectoriais e profissionais.',
  'The marketplace is also a moderated knowledge network. Readers can follow reviewed explanations and questions while private Enterprise engagements remain separate.': 'O mercado de especialistas é também uma rede de conhecimento moderada. Os leitores podem acompanhar explicações e perguntas revistas, enquanto os compromissos empresariais privados permanecem separados.',
  'Open all circles': 'Abrir todos os círculos',
  'Different institutions make different decisions.': 'Instituições diferentes tomam decisões diferentes.',
  'African Specialist Knowledge Circles': 'Círculos de conhecimento de especialistas africanos',
  'Cancel': 'Cancelar',
  'Clear title': 'Título claro',
  'Contribute to': 'Contribuir para',
  'Contribution': 'Contributo',
  'Contribution standards': 'Normas de contribuição',
  'Contribution type': 'Tipo de contributo',
  'Corrected': 'Corrigido',
  'Disclosure:': 'Declaração:',
  'Enterprise Decision Communities': 'Comunidades empresariais de decisão',
  'Enterprise decision communities': 'Comunidades empresariais de decisão',
  'Enterprise overview': 'Visão geral empresarial',
  'Follow circle': 'Seguir círculo',
  'Following circle': 'A seguir o círculo',
  'Knowledge circles could not be loaded. No substitute or generated activity is being shown.': 'Não foi possível carregar os círculos de conhecimento. Não é apresentada actividade de substituição nem inventada.',
  'Measured standing': 'Estatuto avaliado',
  'Private decisions': 'Decisões privadas',
  'Public knowledge': 'Conhecimento público',
  'Request circle membership': 'Pedir adesão ao círculo',
  'Respond': 'Responder',
  'Response': 'Resposta',
  'Response could not be submitted.': 'Não foi possível enviar a resposta.',
  'Reviewed community knowledge': 'Conhecimento comunitário revisto',
  'Reviewed contributions could not be loaded.': 'Não foi possível carregar os contributos revistos.',
  'Reviewed public knowledge': 'Conhecimento público revisto',
  'Show my approved public identity. Otherwise BOA displays a role-only identity. Specialist public profiles remain attributed.': 'Mostrar a minha identidade pública aprovada. Caso contrário, a BOA apresenta apenas a função. Os perfis públicos de especialistas permanecem atribuídos.',
  'Sign in to contribute': 'Iniciar sessão para contribuir',
  'Sign in to react': 'Iniciar sessão para reagir',
  'Sign in to respond': 'Iniciar sessão para responder',
  'Sources supplied': 'Fontes fornecidas',
  'Specialist directory': 'Directório de especialistas',
  'Specialist knowledge network': 'Rede de conhecimento especializado',
  'Submitting…': 'A enviar…',
  '[dynamic] response-': '[dinâmico] resposta-',
  '[dynamic] response-sources-': '[dinâmico] fontes-da-resposta-',
  'reviewed contributions ·': 'contributos revistos ·',
  'reviewed responses': 'respostas revistas',
  'Public professional knowledge': 'Conhecimento profissional público',
  'Knowledge-network health check failed': 'A verificação da saúde da rede de conhecimento falhou',
  'Knowledge-network migration is not fully applied': 'A migração da rede de conhecimento não foi integralmente aplicada',
};
...
const PORTUGUESE_INTERFACE_FRAGMENTS: Readonly<Record<string, string>> = {
  ...
  'unit': 'unidade',
  'and': 'e',
  'Record the editorial synthesis and private review reason before deciding': 'Registe a síntese editorial e a justificação privada da revisão antes de decidir',
  'Room review failed': 'A revisão da sala falhou',
  'Record an item review reason before deciding': 'Registe uma justificação para a revisão do elemento antes de decidir',
  'Evidence item published': 'Elemento documental publicado',
  'Evidence item rejected': 'Elemento documental rejeitado',
  'Evidence item review failed': 'A revisão do elemento documental falhou',
  'Select an approved specialist': 'Seleccione um especialista aprovado',
  'Specialist invited to the decision room': 'Especialista convidado para a sala de decisão',
  'Specialist invitation failed': 'O convite ao especialista falhou',
  'Confirm consent, remove private detail, establish the initial synthesis and publish explicit verification priorities.': 'Confirme o consentimento, retire pormenores privados, estabeleça a síntese inicial e publique prioridades explícitas de verificação.',
  'Required public editorial synthesis': 'Síntese editorial pública obrigatória',
  'Approve and publish room': 'Aprovar e publicar a sala',
  'No public decision rooms are awaiting review.': 'Não há salas de decisão públicas a aguardar revisão.',
  'Decision-room evidence review': 'Revisão documental da sala de decisão',
  'Check attribution, source support, confidence label, confidentiality and conflicts before adding anything to a room ledger.': 'Verifique a atribuição, o apoio das fontes, o grau de confiança, a confidencialidade e os conflitos antes de acrescentar qualquer elemento ao registo da sala.',
  'Required item review record': 'Registo obrigatório da revisão do elemento',
  'Approve evidence item': 'Aprovar elemento documental',
  'No room evidence items are awaiting review.': 'Não há elementos documentais da sala a aguardar revisão.',
  'Invite approved specialists only where their documented coverage fits the room’s countries, sectors and verification priorities.': 'Convide apenas especialistas aprovados cuja experiência documentada corresponda aos países, sectores e prioridades de verificação da sala.',
  'No approved open decision rooms are ready for specialist invitations.': 'Não há salas de decisão abertas e aprovadas prontas para convites a especialistas.',
  'Open evidence room': 'Abrir sala documental',
  'Follow the question, evidence and unresolved work.': 'Acompanhe a questão, os elementos documentais e o trabalho por resolver.',
  'Rooms combine official records, reviewed professional interpretation, contradictions, verification priorities and documented outcomes without turning discussion into fact.': 'As salas reúnem registos oficiais, interpretação profissional revista, contradições, prioridades de verificação e resultados documentados, sem transformar discussão em facto.',
  'Explore all rooms': 'Explorar todas as salas',
  'Loading active decision rooms…': 'A carregar salas de decisão activas…',
  'Official evidence': 'Elementos oficiais',
  'Contradictory evidence': 'Elementos contraditórios',
  'Trace real market questions through evidence, specialist interpretation, unresolved verification work and documented outcomes.': 'Acompanhe questões reais de mercado através de elementos documentais, interpretação de especialistas, verificações por resolver e resultados registados.',
  'Questions become traceable evidence work.': 'As questões tornam-se trabalho documental rastreável.',
  'Follow consequential African market questions from the initial decision through official evidence, specialist interpretation, disagreement, verification and documented outcomes.': 'Acompanhe questões determinantes dos mercados africanos desde a decisão inicial até aos elementos oficiais, à interpretação especializada, à divergência, à verificação e aos resultados documentados.',
  'Open an Enterprise room': 'Abrir uma sala Enterprise',
  'Evidence review': 'Revisão documental',
  'Loading decision rooms…': 'A carregar salas de decisão…',
  'No reviewed rooms in this view yet': 'Ainda não há salas revistas nesta vista',
  'BOA does not invent activity. Consented rooms appear only after the decision owner and editorial reviewer approve their public boundaries.': 'A BOA não inventa actividade. As salas autorizadas só aparecem depois de o responsável pela decisão e o revisor editorial aprovarem os respectivos limites públicos.',
  'Evidence links': 'Ligações às fontes',
  'Add to the evidence ledger': 'Acrescentar ao registo documental',
  'Submission never changes the room record until human review.': 'Uma contribuição nunca altera o registo da sala antes da revisão humana.',
  'Source links, separated by commas': 'Ligações às fontes, separadas por vírgulas',
  'Received for human review; it is not public yet.': 'Recebido para revisão humana; ainda não é público.',
  'Submit to review': 'Enviar para revisão',
  'Loading the evidence room…': 'A carregar a sala documental…',
  'It may be private, under review or no longer published.': 'Pode ser privada, estar em revisão ou já não se encontrar publicada.',
  'Current editorial synthesis': 'Síntese editorial actual',
  'What the reviewed record currently supports': 'O que o registo revisto actualmente sustenta',
  'The room is open. BOA will publish a synthesis after reviewed evidence establishes a supportable position.': 'A sala está aberta. A BOA publicará uma síntese quando os elementos revistos permitirem sustentar uma posição.',
  'Priorities will be published after editorial review.': 'As prioridades serão publicadas após revisão editorial.',
  'Evidence ledger': 'Registo documental',
  'Trace what is known, interpreted and unresolved.': 'Distinga o que é conhecido, interpretado e permanece por resolver.',
  'The evidence ledger is awaiting its first approved item': 'O registo documental aguarda o primeiro elemento aprovado',
  'Submitted material remains invisible until its evidence, attribution, confidentiality and disclosure boundaries are reviewed.': 'O material enviado permanece invisível até serem revistos os seus elementos, atribuição, confidencialidade e limites de divulgação.',
  'Loading your private decision room…': 'A carregar a sua sala de decisão privada…',
  'Only the Enterprise owner and accepted specialists can access this room.': 'Apenas o responsável Enterprise e os especialistas aceites podem aceder a esta sala.',
  'Current synthesis': 'Síntese actual',
  'The room is open and awaiting reviewed evidence.': 'A sala está aberta e aguarda elementos revistos.',
  'No evidence items have passed review yet.': 'Ainda nenhum elemento documental passou a revisão.',
  'A provisioned Enterprise account is required to open private or consented-public evidence work.': 'É necessária uma conta Enterprise habilitada para abrir trabalho documental privado ou público mediante consentimento.',
  'Create and manage structured African market decision rooms.': 'Crie e gira salas estruturadas de decisão sobre mercados africanos.',
  'Move from a question to an evidence-ready decision.': 'Passe de uma questão a uma decisão sustentada por elementos verificáveis.',
  'Define the decision, invite relevant specialists through BOA review, track contradictions and unresolved work, and preserve a dated outcome record.': 'Defina a decisão, convide especialistas relevantes mediante revisão da BOA, acompanhe contradições e trabalho por resolver e preserve um registo datado do resultado.',
  'Open a decision room': 'Abrir uma sala de decisão',
  'Who must be able to use the result?': 'Quem deve poder utilizar o resultado?',
  'Public after consent and review': 'Pública após consentimento e revisão',
  'I consent to publication of this bounded question and context after editorial review. Private engagement details remain excluded.': 'Autorizo a publicação desta questão delimitada e do respectivo contexto após revisão editorial. Os pormenores privados da colaboração permanecem excluídos.',
  'I confirm this room contains no confidential, personal, regulated or material non-public information.': 'Confirmo que esta sala não contém informação confidencial, pessoal, sujeita a regulação ou informação relevante que não seja pública.',
  'Open decision room': 'Abrir sala de decisão',
  'Your rooms': 'As suas salas',
  'Current evidence work': 'Trabalho documental actual',
  'Loading your rooms…': 'A carregar as suas salas…',
  'evidence items': 'elementos documentais',
  'Open public room': 'Abrir sala pública',
  'Open private workspace': 'Abrir espaço de trabalho privado',
  'Decision rooms could not be loaded.': 'Não foi possível carregar as salas de decisão.',
  'Evidence': 'Elementos documentais',
  'Live decision rooms': 'Salas de decisão activas',
  'Outcomes': 'Resultados',
  'Unresolved': 'Por resolver',
  'Add reviewed knowledge': 'Acrescentar conhecimento para revisão',
  'African Decision Rooms': 'Salas Africanas de Decisão',
  'All public rooms': 'Todas as salas públicas',
  'BOA decision network': 'Rede de decisão da BOA',
  'Context already established': 'Contexto já estabelecido',
  'Decision room unavailable': 'Sala de decisão indisponível',
  'Editorial priorities have not yet been recorded.': 'As prioridades editoriais ainda não foram registadas.',
  'Enterprise Decision Rooms': 'Salas de Decisão Enterprise',
  'Follow room': 'Seguir sala',
  'Following room': 'A seguir a sala',
  'Item type': 'Tipo de elemento',
  'No rooms opened yet': 'Ainda não foram abertas salas',
  'Opening room…': 'A abrir a sala…',
  'Private': 'Privada',
  'Private Enterprise room': 'Sala Enterprise privada',
  'Private decision room unavailable': 'Sala de decisão privada indisponível',
  'Private decision workspace': 'Espaço privado de decisão',
  'Private room': 'Sala privada',
  'Relevant conflict or commercial relationship': 'Conflito ou relação comercial relevante',
  'Resolved': 'Resolvida',
  'Reviewed room ledger': 'Registo revisto da sala',
  'Room could not be created.': 'Não foi possível criar a sala.',
  'Room title': 'Título da sala',
  'Sign in to ask an unresolved question': 'Inicie sessão para colocar uma questão por resolver',
  'Specialist knowledge circles': 'Círculos de conhecimento especializado',
  'Verification priorities': 'Prioridades de verificação',
  'Visibility': 'Visibilidade',
  'reviewed items ·': 'elementos revistos ·',
  'Decision rooms': 'Salas de decisão',
  'Accept room': 'Aceitar sala',
  'Decision-room invitations': 'Convites para salas de decisão',
  'Decision-room invitations could not load.': 'Não foi possível carregar os convites para salas de decisão.',
  'No decision-room invitations yet.': 'Ainda não há convites para salas de decisão.',
  'Record the stewardship review before deciding': 'Registe a revisão da tutela antes de decidir',
  'Approval requires a receiving circle, public summary and steward name': 'A aprovação exige um círculo de destino, uma síntese pública e o nome do responsável',
  'Transition review failed': 'A revisão da transição falhou',
  'Name the invitation before creating it': 'Dê um nome ao convite antes de o criar',
  'Invitation token created and copied': 'Código de convite criado e copiado',
  'Verify stewardship and consent before connecting any established external community to a BOA circle. Never import member lists or private posts.': 'Verifique a tutela e o consentimento antes de ligar qualquer comunidade externa estabelecida a um círculo da BOA. Nunca importe listas de membros nem publicações privadas.',
  'Loading community transition applications…': 'A carregar candidaturas de transição comunitária…',
  'Proposed boundary': 'Limite proposto',
  'Select a reviewed circle': 'Seleccione um círculo revisto',
  'Required private stewardship and consent review': 'Revisão privada obrigatória da tutela e do consentimento',
  'Continue review': 'Prosseguir a revisão',
  'No community transition applications are awaiting review.': 'Não há candidaturas de transição comunitária a aguardar revisão.',
  'Create channel-specific links and compare observed visits, activations and contributors.': 'Crie ligações específicas por canal e compare visitas, activações e colaboradores observados.',
  'Loading active transition records…': 'A carregar registos de transição activos…',
  'A consent-led transition programme for established African professional, sector, regional and diaspora communities.': 'Um programa de transição assente no consentimento para comunidades profissionais, sectoriais, regionais e da diáspora africana já estabelecidas.',
  'Keep the community. Add evidence, standing and decision impact.': 'Mantenha a comunidade. Acrescente elementos verificáveis, reconhecimento e impacto nas decisões.',
  'Established communities do not need another empty forum. BOA gives a steward-led group a reviewed African knowledge layer: official evidence, specialist interpretation, Decision Rooms and outcomes that remain traceable.': 'As comunidades estabelecidas não precisam de mais um fórum vazio. A BOA oferece a um grupo conduzido pelos seus responsáveis uma camada revista de conhecimento africano: elementos oficiais, interpretação especializada, Salas de Decisão e resultados rastreáveis.',
  'View active transitions': 'Ver transições activas',
  'The existing name, purpose, rules and stewardship remain visible. BOA does not impersonate the community or claim a migration that has not occurred.': 'O nome, o propósito, as regras e a tutela existentes permanecem visíveis. A BOA não se faz passar pela comunidade nem declara uma migração que não ocorreu.',
  'Invitation links support voluntary movement. No membership list, private post or personal profile is copied from another platform.': 'As ligações de convite permitem uma passagem voluntária. Nenhuma lista de membros, publicação privada ou perfil pessoal é copiado de outra plataforma.',
  'Reviewed discussions can connect to country evidence, sector performance, specialist standing, verification work and documented decisions.': 'As discussões revistas podem ligar-se a elementos nacionais, desempenho sectorial, reconhecimento especializado, trabalho de verificação e decisões documentadas.',
  'Communities moving with explicit consent.': 'Comunidades em transição com consentimento explícito.',
  'Loading reviewed transition programmes…': 'A carregar programas de transição revistos…',
  'Transition open': 'Transição aberta',
  'View transition record': 'Ver registo da transição',
  'The first public programme will appear only after BOA verifies stewardship, consent, the community boundary and the receiving circle.': 'O primeiro programa público só aparecerá depois de a BOA verificar a tutela, o consentimento, os limites da comunidade e o círculo de destino.',
  'BOA reviews the applicant’s authority, the proposed public boundary and the fit with an existing circle before publishing anything.': 'A BOA revê a autoridade do candidato, o limite público proposto e a adequação a um círculo existente antes de publicar qualquer informação.',
  'No scraping, purchased lists or involuntary account creation.': 'Sem recolha automática, listas compradas ou criação involuntária de contas.',
  'Invitation and activation counts are observed, not estimated social proof.': 'As contagens de convites e activações são observadas, não constituem prova social estimada.',
  'External content remains external unless its author submits it under BOA’s review rules.': 'O conteúdo externo permanece externo, salvo se o autor o submeter ao abrigo das regras de revisão da BOA.',
  'Current platform': 'Plataforma actual',
  'Your stewardship role': 'A sua função de tutela',
  'Approximate member range': 'Intervalo aproximado de membros',
  'Languages used by the community': 'Línguas utilizadas pela comunidade',
  'Evidence that you can represent or formally invite this community': 'Elementos que comprovem que pode representar ou convidar formalmente esta comunidade',
  'What should members gain on BOA?': 'O que devem os membros obter na BOA?',
  'What must remain private or stay on the current platform?': 'O que deve permanecer privado ou na plataforma actual?',
  'I have authority to make this proposal or can obtain formal approval from the community’s recognised stewards.': 'Tenho autoridade para apresentar esta proposta ou posso obter a aprovação formal dos responsáveis reconhecidos da comunidade.',
  'I will not upload, sell or transfer member lists, private posts or personal data to BOA.': 'Não carregarei, venderei nem transferirei para a BOA listas de membros, publicações privadas ou dados pessoais.',
  'I consent to BOA reviewing this application and contacting me about the proposed transition.': 'Autorizo a BOA a rever esta candidatura e a contactar-me acerca da transição proposta.',
  'Application received. Nothing will be represented publicly until stewardship and consent are reviewed.': 'Candidatura recebida. Nada será representado publicamente antes da revisão da tutela e do consentimento.',
  'Submit steward application': 'Enviar candidatura do responsável',
  'Loading the transition record…': 'A carregar o registo da transição…',
  'It may still be under stewardship review or no longer open.': 'Pode ainda estar em revisão da tutela ou já não se encontrar aberta.',
  'Join the BOA circle without leaving your history behind.': 'Junte-se ao círculo da BOA sem abandonar o seu historial.',
  'Membership here is voluntary. BOA does not copy your external profile or posts. Joining activates this transition record and follows the connected knowledge circle so its reviewed questions and contributions become easier to find.': 'A adesão é voluntária. A BOA não copia o seu perfil externo nem as suas publicações. Ao aderir, activa este registo de transição e passa a seguir o círculo de conhecimento associado, tornando mais fáceis de encontrar as suas questões e contribuições revistas.',
  'Join this transition': 'Aderir a esta transição',
  'Sign in and join': 'Iniciar sessão e aderir',
  'Sign in to follow the circle': 'Iniciar sessão para seguir o círculo',
  'Visit the existing community': 'Visitar a comunidade existente',
  'You are counted as an activated member and now follow the connected BOA circle.': 'Foi registado como membro activado e segue agora o círculo da BOA associado.',
  'The invitation could not be activated. It may have expired.': 'Não foi possível activar o convite. Pode ter expirado.',
  'These are recorded BOA actions. They are not the external community’s claimed membership total.': 'Estas são acções registadas na BOA. Não correspondem ao total de membros declarado pela comunidade externa.',
  'Public transition boundary': 'Limite público da transição',
  'Defined by the receiving BOA circle.': 'Definido pelo círculo de destino da BOA.',
  'Its identity, rules, membership and archive remain under its existing stewardship.': 'A sua identidade, regras, membros e arquivo permanecem sob a tutela existente.',
  'Only voluntary activations and reviewed contributions are represented in BOA metrics.': 'Apenas as activações voluntárias e as contribuições revistas são representadas nas métricas da BOA.',
  'Activated': 'Activados',
  'Activated contributors': 'Colaboradores activados',
  'Activated members': 'Membros activados',
  'Activating…': 'A activar…',
  'BOA Circle Launchpad': 'Plataforma de lançamento de círculos da BOA',
  'BOA participation': 'Participação na BOA',
  'Bring an Established Community to BOA': 'Trazer uma comunidade estabelecida para a BOA',
  'Community name': 'Nome da comunidade',
  'Connected circle:': 'Círculo associado:',
  'Connected scope': 'Âmbito associado',
  'Contribution gains consequence': 'A contribuição ganha consequência',
  'Contributors': 'Colaboradores',
  'English, French, Portuguese': 'Inglês, francês, português',
  'Existing community': 'Comunidade existente',
  'Finance, energy, technology': 'Finanças, energia, tecnologia',
  'From': 'Origem',
  'Identity stays intact': 'A identidade mantém-se intacta',
  'Invitation visits': 'Visitas por convite',
  'Kenya, Nigeria, South Africa': 'Quénia, Nigéria, África do Sul',
  'Members choose': 'Os membros escolhem',
  'No transition is represented without approval': 'Nenhuma transição é representada sem aprovação',
  'Observed progress': 'Progresso observado',
  'Observed transition programmes': 'Programas de transição observados',
  'Propose a responsible transition.': 'Proponha uma transição responsável.',
  'Propose a transition': 'Propor uma transição',
  'Public community link': 'Ligação pública da comunidade',
  'Steward application': 'Candidatura do responsável',
  'Steward:': 'Responsável:',
  'Transition completed': 'Transição concluída',
  'Transition programmes could not be loaded.': 'Não foi possível carregar os programas de transição.',
  'Transition record unavailable': 'Registo da transição indisponível',
  'Voluntary transition': 'Transição voluntária',
  'active or completed': 'activas ou concluídas',
  '· Receiving circle:': '· Círculo de destino:',
  'Bring an existing community': 'Trazer uma comunidade existente',
  '[dynamic] Community Transition': 'Transição comunitária',
  'Community Transition': 'Transição comunitária',
  'Editorial review:': 'Revisão editorial:',
  'Use the structured form to begin with a decision and an explicit evidence boundary.': 'Utilize o formulário estruturado para começar com uma decisão e um limite documental explícito.',
  'Open a Decision Room': 'Abrir uma sala de decisão',
  'Accept only rooms where your documented country, sector or professional experience is relevant.': 'Aceite apenas salas nas quais a sua experiência profissional, nacional ou sectorial documentada seja relevante.',
  'Loading room invitations…': 'A carregar convites para salas…',
  ...
  'About BOA': 'Sobre a BOA',
  'Sign in': 'Entrar',
  'Network': 'Rede',
  'Mercados': 'Mercados',
  'Rede': 'Rede',
  'Pesquisa guardada': 'Pesquisa guardada',
  '[dynamic] destinations': 'destinos',
  'destinations': 'destinos',
  'Your market questions, specialist work and decision records in one workspace.': 'As suas questões de mercado, o trabalho especializado e os registos de decisão num único espaço.',
  'Review active requests, proposals and engagements.': 'Consulte pedidos, propostas e compromissos activos.',
  'Manage private and consented-public evidence work.': 'Gira o trabalho documental reservado e público mediante consentimento.',
  'Access and account': 'Acesso e conta',
  'Review your provisioned Enterprise access.': 'Consulte o seu acesso empresarial atribuído.',
  'Your professional profile, invitations and evidence-led contribution spaces.': 'O seu perfil profissional, os convites e os espaços de contribuição orientados por elementos documentais.',
  'Manage your profile, standing and opportunities.': 'Gira o seu perfil, o seu estatuto e as oportunidades.',
  'Respond where your documented experience is relevant.': 'Responda quando a sua experiência documentada for pertinente.',
  'Review the public network and published profiles.': 'Consulte a rede pública e os perfis publicados.',
  'Your briefing, saved research and current reporting in one place.': 'A sua síntese, a pesquisa guardada e a cobertura actual num único lugar.',
  'Your briefing': 'A sua síntese',
  'Return to reports and evidence you have kept.': 'Volte aos relatórios e elementos documentais que guardou.',
  'Member account': 'Conta de membro',
  'Review membership access and account status.': 'Consulte o acesso de membro e o estado da conta.',
  'Navigation evidence': 'Elementos de navegação',
  'Which paths readers choose': 'Que percursos escolhem os leitores',
  'Observed selections from the homepage gateway, desktop and mobile menus, journey bar and footer. These counts show chosen destinations, not whether a task was completed.': 'Selecções observadas no portal inicial, nos menus de computador e telemóvel, na barra de percurso e no rodapé. Estas contagens mostram destinos escolhidos, não indicam se uma tarefa foi concluída.',
  'Observed selections from the homepage gateway, desktop and mobile menus, journey bar and footer. Repeat and cross-journey movement may reflect exploration or reconsideration; neither proves confusion or task failure.': 'Selecções observadas no portal inicial, nos menus de computador e telemóvel, na barra de percurso e no rodapé. A repetição e a passagem entre percursos podem reflectir exploração ou reconsideração; nenhuma delas prova confusão ou insucesso na tarefa.',
  '3+ selections': '3+ selecções',
  'Multiple journeys': 'Vários percursos',
  'Journey selections will appear after readers use the newly instrumented navigation.': 'As selecções de percursos aparecerão depois de os leitores utilizarem a navegação agora medida.',
  'Journey funnel evidence': 'Elementos do funil de percursos',
  'What readers do after choosing a path': 'O que fazem os leitores depois de escolherem um percurso',
  'Each row follows the same hashed session after a recorded navigation selection. Progress means a journey page opened; the final milestone is the specific observed product action shown below.': 'Cada linha acompanha a mesma sessão anonimizada depois de uma selecção de navegação registada. O progresso significa que foi aberta uma página do percurso; o marco final é a acção específica observada no produto e indicada abaixo.',
  'Journey funnel measurements will appear after newly instrumented sessions select and use a path.': 'As medições do funil de percursos aparecerão depois de as novas sessões medidas seleccionarem e utilizarem um percurso.',
  'A product milestone is not evidence of satisfaction, a successful decision, a completed engagement, revenue or real-world impact.': 'Um marco do produto não constitui prova de satisfação, de uma decisão bem-sucedida, de um compromisso concluído, de receitas ou de impacto no mundo real.',
  'What are you here to do?': 'O que pretende fazer?',
  'Choose a path once. Related reporting, market evidence, professional exchange and Enterprise work remain connected without competing for attention.': 'Escolha um percurso. A cobertura relacionada, os elementos de mercado, o intercâmbio profissional e o trabalho empresarial mantêm-se ligados sem competir pela atenção.',
  'Enter this path': 'Entrar neste percurso',
  'One platform, four clear paths': 'Uma plataforma, quatro percursos claros',
  'Follow current reporting and explainers from across Africa.': 'Acompanhe a cobertura actual e as explicações de todo o continente africano.',
  'The essential developments in one concise view.': 'Os desenvolvimentos essenciais numa leitura concisa.',
  'Reporting, analysis and source-linked context.': 'Cobertura, análise e contexto ligado às fontes.',
  'Relevant summits, forums and public convenings.': 'Cimeiras, fóruns e encontros públicos relevantes.',
  'Receive the editorial briefing by email.': 'Receba a síntese editorial por correio electrónico.',
  'Compare countries, sectors and continental market evidence.': 'Compare países, sectores e elementos de mercado continentais.',
  'Performance signals, evidence and sector detail.': 'Sinais de desempenho, elementos documentais e pormenor sectorial.',
  'National evidence, reporting and market context.': 'Elementos nacionais, cobertura e contexto de mercado.',
  'Longer-form decision and evidence briefs.': 'Dossiês aprofundados de decisão e elementos documentais.',
  'Find credible specialists and join evidence-led professional exchange.': 'Encontre especialistas credíveis e participe num intercâmbio profissional orientado por elementos documentais.',
  'Find screened expertise by market and sector.': 'Encontre conhecimentos especializados avaliados por mercado e sector.',
  'Follow evidence, questions and documented outcomes.': 'Acompanhe elementos documentais, perguntas e resultados registados.',
  'Turn a defined market question into a governed decision process.': 'Transforme uma questão de mercado definida num processo de decisão governado.',
  'Understand the service, scope and operating model.': 'Compreenda o serviço, o âmbito e o modelo de funcionamento.',
  'Define a practical, lower-risk first engagement.': 'Defina um primeiro compromisso prático e de menor risco.',
  'Submit a structured specialist requirement.': 'Apresente uma necessidade estruturada de conhecimentos especializados.',
  'Enter the private Enterprise environment.': 'Entre no espaço empresarial reservado.',
};
...
const translatePortugueseDynamicInterfaceText = (value: string): string | undefined => {
  ...
  if ((match = value.match(/^(.+) Community Transition$/i))) return `Transição comunitária — ${match[1]}`;
