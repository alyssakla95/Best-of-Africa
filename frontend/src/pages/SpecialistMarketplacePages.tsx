...
import { ResponsiveProgressTimeline } from '@/components/ResponsiveProgressTimeline';
...
export function SpecialistsDirectoryPage() {
  ...
  return <div className="page-container py-12 md:py-16">
    ...
    <header className="max-w-3xl">
      ...
      <div className="mt-6 grid gap-3 sm:flex sm:flex-wrap"><Button asChild><a href="#directory">Browse specialists</a></Button><Button asChild variant="outline"><Link to="/specialists/circles">Explore knowledge circles</Link></Button><Button asChild variant="ghost"><Link to="/specialists/interest">Express interest in joining</Link></Button><Button asChild variant="ghost"><Link to="/specialists/sign-in">Specialist sign in</Link></Button></div>
    </header>
    ...
    <section id="directory" className="mt-8 scroll-mt-36 rounded-2xl border p-4" aria-labelledby="directory-filters">
...
export function SpecialistDashboardPage() {
  ...
  return <div className="page-container py-12">
    ...
    <ResponsiveProgressTimeline items={lifecycle} currentIndex={currentStep} label="Listing lifecycle" columnsClass="sm:grid-cols-5" statusLabel={index => index < currentStep ? '✓ Complete' : index === currentStep ? 'Current step' : 'Step ' + (index + 1)} />
...
export function SpecialistRequestPage() {
  ...
  return <div className="page-container py-12"><SEO title="Specialist request" description="Private Enterprise specialist request." noIndex />
    ...
    <ResponsiveProgressTimeline items={requestStages.map(pretty)} currentIndex={stageIndex} label="Request status timeline" columnsClass="sm:grid-cols-4" statusLabel={index => index < stageIndex ? '✓ Complete' : index === stageIndex ? 'Current status' : 'Upcoming'} />
