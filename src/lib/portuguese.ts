...
const REPLACEMENTS: ReadonlyArray<readonly [RegExp, Replacement]> = [
    ...
    [/\bplanejar\b/gi, 'planear'],
    [/\bplaneja\b/gi, 'planeia'],
    [/\bplanejam\b/gi, 'planeiam'],
    [/\bplanejado(s|a|as)?\b/gi, 'planeado$1'],
    [/\bgerenciamento\b/gi, 'gestão'],
    [/\bIndo além de\b/g, 'Para além de'],
    [/\bcommodities\b/gi, 'matérias-primas'],
    [/\bem nossas\b/gi, 'nas nossas'],
    [/\bem nossos\b/gi, 'nos nossos'],
    [/\bentender\b/gi, 'compreender'],
    [/\bcompreender nossas\b/gi, 'compreender as nossas'],
    [/\bcompreender nossos\b/gi, 'compreender os nossos'],
    [/\bmercado de câmbio\b/gi, 'mercado cambial'],
    [/\bampliar a participação\b/gi, 'aumentar a participação'],
    [/\bfortalecer\b/gi, 'reforçar'],
    [/\bestá envelhecendo\b/gi, 'está a envelhecer'],
